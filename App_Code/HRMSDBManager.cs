...
/// <summary>
/// Summary description for HRMSDBManager
/// </summary>
public class HRMSDBManager
{
	...
	public HRMSDBManager()
	{
		//
		// TODO: Add constructor logic here
		//
        conn.ConnectionString = @" SERVER=182.18.162.51;DATABASE=HRMS;UID=sa;PASSWORD=Vyshnavi@123";
	}
    ...
    public bool insertemployeData(string TableName, string feildsseparatedbycomma)
    {
        lock (obj_lock)
        {
            try
