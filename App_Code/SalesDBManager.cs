...
public class SalesDBManager
{
    ...
    //  public string UserName = "";
      ...
      {
          //conn.ConnectionString = @" SERVER=223.196.32.27;DATABASE=Dairy_ERP;UID=sa;PASSWORD=vyshnavi123;";
          //conn.ConnectionString = @" SERVER=223.196.32.28;DATABASE=Dairy_ERP;UID=sa;PASSWORD=vyshnavi123;";
          //   ERP - Production Module  
          conn.ConnectionString = @" SERVER=182.18.162.51;DATABASE=Dairy_ERP;UID=sa;PASSWORD=Vyshnavi@123;";
          //anandnan sir db
          //conn.ConnectionString = @" SERVER=192.168.0.72;DATABASE=Dairy_ERP;UID=sa;PASSWORD=Vyshnavi123;";
          //conn.ConnectionString = @" SERVER=192.168.0.55;DATABASE=Dairy_ERP;UID=sa;PASSWORD=sap@123;";
          //conn.ConnectionString = @" SERVER=192.168.0.78;DATABASE=Dairy_ERP;UID=sa;PASSWORD=Vyshnavi123;";
