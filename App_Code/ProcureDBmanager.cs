...
/// <summary>
/// Summary description for ProcureDBmanager
/// </summary>
public class ProcureDBmanager
{
    ...
    //  public string UserName = "";
      ...
      public ProcureDBmanager()
      {
          ...
          //conn.ConnectionString = @" SERVER=49.50.65.160;DATABASE=AMPS;UID=sa;PASSWORD=WHHWYE%23@^#%;";
          conn.ConnectionString = @" SERVER=182.18.138.228;DATABASE=AMPS;UID=sa;PASSWORD=Vyshnavi@123;";
