<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="BrandwiseFilmConsumption.aspx.cs" Inherits="BrandwiseFilmConsumption" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                   <i class="fa fa-get-pocket" aria-hidden="true"></i> Brand Wise Packets<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#"> Brand Wise Packets Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i> Brand Wise Packets Report Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
