<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="samplesqltytest.aspx.cs" Inherits="samplesqltytest" %>
...
<script type="text/javascript">
    ...
    function get_batchqualitytesting_details() {
        var data = { 'op': 'get_tankerqualitytesting_details' };
        var s = function (msg) {
            if (msg) {
                if (msg.length > 0) {
