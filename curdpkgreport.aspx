<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="curdpkgreport.aspx.cs" Inherits="curdpkgreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Curd Packing Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Curd Packing Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Curd Packing Report Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center" >
                        ...
                        <tr>
                        <td>
                             <asp:Label ID="Label2" runat="server" Text="Label">Report Type</asp:Label>&nbsp;
                                ...
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <asp:Panel ID="panel_day" runat="server" Visible="false">
                                         ...
                                         <div >
                                          <asp:Panel ID="panel_month" runat="server" Visible="false">
                                            <asp:GridView ID="grdReports_mnth" runat="server" ForeColor="White" Width="100%" CssClass="gridcls" 
                                                GridLines="Both" Font-Bold="true" OnDataBinding="grdday_DataBinding" OnRowDataBound="grdday_RowDataBound" OnRowCommand="grdrecipts_RowCommand">
                                                <EditRowStyle BackColor="#999999" />
                                                <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                                <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                                    Font-Names="Raavi" Font-Size="Small" />
                    ...
                    <asp:Label ID="Label1" runat="server" Text="" ForeColor="Red" Font-Size="20px"></asp:Label>
                </div>
                </div>
                <div id="dialog" style="display: none;" >
                    <asp:GridView ID="GrdProducts" runat="server" ForeColor="White" Width="260%" CssClass="gridcls"
