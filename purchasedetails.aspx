<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="purchasedetails.aspx.cs" Inherits="purchasedetails" %>
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Inward Tanker Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                        <table>
                            <tr>
                                     <td>
                                        <asp:Label ID="Label8" runat="server" Text="Label">Select Voucher Type</asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddltype" runat="server" CssClass="form-control" AutoPostBack="True"
                                            OnSelectedIndexChanged="ddltype_SelectedIndexChanged">
                                            <asp:ListItem selected disabled value="Select Type">Select Type</asp:ListItem>
                                            <asp:ListItem>Purchase Voucher</asp:ListItem>
                                            <asp:ListItem>Direct Purchase Voucher</asp:ListItem>
                                            <asp:ListItem>Other Party Direct Purchase Voucher</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    </td>
                                    <td>
                                    <asp:Panel ID="hiddentype" runat="server" Visible="false">
                                        ...
                                        <asp:DropDownList ID="ddltankertypepurchase" runat="server" CssClass="form-control" >
                                    ...
                                    <asp:Panel ID="hiddenbrances" runat="server" Visible="false">
                                        ...
                                        <asp:DropDownList ID="ddlbranchTypepurchase" runat="server" CssClass="form-control" >
                                    ...
                                    <td>
                                     <asp:Panel ID="hiddenwise" runat="server" Visible="false">
                                        ...
                                        <asp:DropDownList ID="ddlBranchwisepurchase" runat="server" CssClass="form-control" AutoPostBack="True"
                                            OnSelectedIndexChanged="ddlBranchpurchase_SelectedIndexChanged">
                                            <asp:ListItem>All</asp:ListItem>
                                    ...
                                    <td>
                                        <asp:Panel ID="hideVehicles" runat="server" Visible="false">
                                            ...
                                            <asp:DropDownList ID="ddlbranchespurchase" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </td>
                                    <td>
                        ...
                        <%--<div id="div_purchasevoucher" runat="server" Visible="false">
                            <table>
                                <tr>
                                 <td>
                                        <asp:Label ID="Label7" runat="server" Text="Label">Tanker Type</asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddltankertypepurchase" runat="server" CssClass="form-control" >
                                            <asp:ListItem>in</asp:ListItem>
                                            <asp:ListItem>Out</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Text="Label">Type</asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddlBranchpurchase" runat="server" CssClass="form-control" AutoPostBack="True"
                                            OnSelectedIndexChanged="ddlBranchpurchase_SelectedIndexChanged">
                                            <asp:ListItem>All</asp:ListItem>
                                            <asp:ListItem>Branch Wise</asp:ListItem>
                                            <asp:ListItem>Vehicle Wise</asp:ListItem>
                                    ...
                                    <td>
                                        <asp:Panel ID="hideVehicles" runat="server" Visible="false">
                                            <asp:Label ID="Label1" runat="server" Text="Label">Branch Name</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlbranchespurchase" runat="server" CssClass="ddlclass">
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Label">Milk Type</asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddlReportTypepurchase" runat="server" CssClass="form-control">
                                            <asp:ListItem>All</asp:ListItem>
                                            <asp:ListItem>Buffalo</asp:ListItem>
                                            <asp:ListItem>Cow</asp:ListItem>
                                            <asp:ListItem>Skim</asp:ListItem>
                                    ...
                                    <td>
                                        <asp:Button ID="Button2" runat="server" Text="GENERATE" CssClass="btn btn-success"
                                            OnClick="btn_Generate_Click_purchase" /><br />
                                    </td>
                                    <td>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/exporttoxl.aspx">Export to XL</asp:HyperLink>
                                    </td>
                        ...
                        <div id="div_directpurchase" runat="server" Visible="false">
                        <table>
                                <tr>
                                <td>
                                    ...
                                    <td>
                                        ...
                                        <asp:DropDownList ID="ddlBranchdirect" runat="server" CssClass="form-control" AutoPostBack="True"
                                            OnSelectedIndexChanged="ddlBranchpurdirect_SelectedIndexChanged">
                                            <asp:ListItem>All</asp:ListItem>
                                            <asp:ListItem>Branch Wise</asp:ListItem>
                                            <asp:ListItem>Vehicle Wise</asp:ListItem>
                                        </asp:DropDownList>
                        ...
                        <div id="div_otherpartydrtpurch" runat="server" Visible="false">
                        <table>
                                <tr>
                                    <td>
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div>
                                         ...
                                         <div>
                                            <asp:Panel ID="plnjv" runat="server">
                                                <asp:GridView ID="grdjv" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                    GridLines="Both" Font-Bold="true">
                                                    <EditRowStyle BackColor="#999999" />
                                                    <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                                    <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
                                ...
                                <asp:Button ID="btnPrint" runat="Server" CssClass="btn btn-success" OnClientClick="javascript:CallPrint('divPrint');"
                                    ...
                                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-success"
                                            OnClick="btn_Save_Purchase_Click" /><br />
