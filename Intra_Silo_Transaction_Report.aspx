<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="Intra_Silo_Transaction_Report.aspx.cs" Inherits="Intra_Silo_Transaction_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Intra SILO Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Intra SILO Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Intra SILO Details
                </h3>
            </div>
            <div class="box-body">
                        ...
                        <div>
                            <div align="center">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" Text="Label">From Silo Name</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlfromsilo" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width:3px;">
                                            </td>
                                        <td>
                                            <asp:Label ID="Label2" runat="server" Text="Label">To Silo Name</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddltosilo" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </td>
                                         <td style="width:3px;">
                                            </td>
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <div align="center">
                                                ...
                                                <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                <br />
                                                <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Intra SILO Transaction
                                                    Report</span><br />
                                            </div>
