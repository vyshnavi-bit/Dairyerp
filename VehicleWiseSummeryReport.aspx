<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="VehicleWiseSummeryReport.aspx.cs" Inherits="VehicleWiseSummeryReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Summery Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Summery Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                                ...
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            Name
                                            <asp:Label ID="lblName" runat="server" Font-Bold="true" Font-Size="16px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                        </div>
