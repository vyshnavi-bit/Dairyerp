<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="purchasevocher.aspx.cs" Inherits="purchasevocher" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    purchase voucher<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Purchase Voucher Report</a></li>
                </ol>
            </section>
                            ...
                            <table>
                                <tr>
                                 <td>
                                        ...
                                        <asp:DropDownList ID="ddltankertype" runat="server" CssClass="form-control" >
