<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="Inward_Silo_Report.aspx.cs" Inherits="Inward_Silo_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdateProgress ID="updateProgress1" runat="server">
     ...
     <section class="content-header">
        <h1>
            Inward SILO Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Inward SILO Report</a></li>
        </ol>
    </section>
                            ...
                            <div style="width: 100%;">
                                ...
                                <div align="center">
                                    ...
                                    <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                        Text=""></asp:Label>
                                    <br />
                                    <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Inward SILO Report</span><br />
                                </div>
