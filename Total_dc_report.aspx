<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="Total_dc_report.aspx.cs" Inherits="Total_dc_report" %>
                        ...
                        <div align="center">
                            <table>
                                <tr>
                                        ...
                                        <asp:Panel ID="pnlBranch" runat="server" Visible="false">
                                         <asp:Label ID="Label2" runat="server" Text="Label">Type</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlBranch" runat="server" CssClass="form-control" AutoPostBack="True"
                                                ...
                                                <asp:ListItem>State & Branch Wise</asp:ListItem>
                                            </asp:DropDownList>
                                        </asp:Panel>
                                    </td>
                                    <td style="width:3px;">
                                    ...
                                    <td>
                                        <asp:Panel ID="hdn_statenames" runat="server" Visible="false">
                                            <asp:Label ID="Label6" runat="server" Text="Label">State Name</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlststenamechange" runat="server" CssClass="form-control" AutoPostBack="True"
                                    ...
                                    <td>
                                        <asp:Panel ID="hdn_companywise" runat="server" Visible="false">
                                            <asp:Label ID="Label7" runat="server" Text="Label">Company Name</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlcompanywise" runat="server" CssClass="form-control" AutoPostBack="True">
                                    ...
                                    <td>
                                        <asp:Panel ID="hdn_statename" runat="server" Visible="false">
                                            <asp:Label ID="Label3" runat="server" Text="Label">State Name</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Total Despatch Report</span><br />
