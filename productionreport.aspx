    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Production Details Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Production Details Report</a></li>
                </ol>
            </section>
                            ...
                            <table>
                                <tr>
                                     <td>
                                        ...
                                        <asp:ListItem Text="CURD & BUTTER MILK" Value="3">CURD & BUTTER MILK</asp:ListItem>
                                        <asp:ListItem Text="KHOVA" Value="2">KHOVA</asp:ListItem>
                                        <asp:ListItem Text="PANEER" Value="1">PANEER</asp:ListItem>
                                        <asp:ListItem Text="PANNER-SPL" Value="4">PANNER-SPL</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width:3px;">
                                            </td>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Curd Production Details Report</span><br />
                                        </div>
                                        ...
                                        <div>
                                            <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                GridLines="Both" Font-Bold="true" OnDataBinding="grdday_DataBinding">
