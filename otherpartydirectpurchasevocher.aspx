<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="otherpartydirectpurchasevocher.aspx.cs" Inherits="otherpartydirectpurchasevocher" %>
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Sales Voucher Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
