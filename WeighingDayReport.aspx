<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="WeighingDayReport.aspx.cs" Inherits="WeighingDayReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                   <i class="fa fa-align-left" aria-hidden="true"></i> Weighing Daily Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Weighing Daily Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Daily Weighing Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                 <td>
                                        <asp:Label ID="Label1" runat="server" Text="Label">Vehicle Type</asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddlslct_vtype" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlslct_SelectedIndexChanged">
                                            <asp:ListItem Text="Select Vehicle Type" Value="0">Select Vehicle Type</asp:ListItem>
                                            <asp:ListItem Text="All" Value="1">All</asp:ListItem>
                                            <asp:ListItem Text="Tanker" Value="2">Tanker</asp:ListItem>
                                            <asp:ListItem Text="puff" Value="3">puff</asp:ListItem>
                                            <asp:ListItem Text="truck" Value="4">Truck</asp:ListItem>
                                            <asp:ListItem Text="RMmodule" Value="5">RMmodule</asp:ListItem>
                                            <asp:ListItem Text="Companywork" Value="6">Companywork</asp:ListItem>
                                            <asp:ListItem Text="others" Value="7">others</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width:3px;">
                                            </td>
                                     <td id="tdvehicleno" runat="server">
                                        <asp:Label ID="Label2" runat="server" Text="Label">Vehicle No</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Weighing Daily Report</span><br />
                                        </div>
                                        ...
                                        <div>
                                            <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" 
                                                CssClass="gridcls" OnDataBinding="gvMenu_DataBinding" OnRowDataBound="grdReports_RowDataBound" 
