<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="BatchEntry_Report.aspx.cs" Inherits="BatchEntry_Report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Batch Preparation<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
                                        ...
                                        <td>
                                            <td>
                                                <asp:Panel ID="hideVehicles" runat="server" Visible="false">
                                                    ...
                                                    <asp:DropDownList ID="ddlbatches" runat="server" CssClass="ddlclass">
                                                    </asp:DropDownList>
                                                </asp:Panel>
                                            </td>
                                        </td>
