<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="weighinginward.aspx.cs" Inherits="weighinginward" %>
                    ...
                    <table align="center">
                        ...
                        <tr>
                         <td>
                            ...
                            <td>
                                <select id="slct_weighingtype" class="form-control" >
                                    <option selected disabled value="Select">Select</option>
                                    <option  value="Grossweight">Grossweight</option>
                                    <option  value="Tareweight">Tareweight</option>
                                </select>
                            </td>
                             <td style="width: 6px;">
                            </td>
