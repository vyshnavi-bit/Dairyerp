...
@keyframes blinker {  
    ...
    <script type="text/javascript">
        ...
        //            results += '<thead><tr role="row" style="background:#5aa4d0; color: white; font-weight: bold;"><th scope="col" style="font-weight: bold;">Employee Name</th><th scope="col" style="font-weight: bold;">LogIn Date</th><th scope="col" style="font-weight: bold;">LogIn Time</th><th scope="col" style="font-weight: bold;">LogOut Time</th><th scope="col" style="font-weight: bold;">Time Interval</th><th scope="col" style="font-weight: bold;">IpAddress</th><th scope="col" style="font-weight: bold;">DeviceType</th></tr></thead></tbody>';
        ...
        //                    results += '<td data-title="Capacity" class="1" style="text-align:center;" onclick="logsclick(\'' + userid + '\');" title="Click here to all login details">' + msg[i].employeename + '</td>';
        ...
        function logsclick(userid) {
            ...
            var userid = userid;
            var data = { 'op': 'get_logindetails_eachemployee', 'userid': userid, 'fromdate': fromdate, 'todate': todate, 'date': date, 'session': session };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content">
        ...
        <!--popup details-->
            ...
            <div class="modal-header" style="background:#5aa4d0; color: white; font-weight: bold;">
                <h4 class="modal-title"> Login Details</h4>
            </div>
            <div class="modal-body">
                        <div id="div_logins" style="height:500px;overflow-y:auto;">
                        </div>
            </div>
            <div class="modal-footer" style="background:#5aa4d0; color: white; font-weight: bold;">
