<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="gheeproductiondetails.aspx.cs" Inherits="gheeproductiondetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function get_gheecreambinding_details() {
            var data = { 'op': 'get_gheecreambinding_details' };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
        ...
        function save_cream_production_click() {
            ...
            if (confi) {
                var data = { 'op': 'save_cream_production_click', 'creamtype': creamtype, 'ob': ob, 'recive': recive, 'recivedfat': recivedfat, 'creamfat': creamfat, 'total': total,
                    'avgfat': avgfat, 'doe': date, 'btnvalue': btnvalue, 'sno': sno, 'oldreciveqty': oldreciveqty
                };
                var s = function (msg) {
                    if (msg) {
                        if (msg.length > 0) {
                ...
                if (msg) {
                    if (msg.length > 0) {
                        ...
                        if (type == 10) {
                            ...
                            var results = '<div    style="overflow:auto;"><table id="table_Ghee_production_details" class="table table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="example2_info">';
                            results += '<thead><tr><th scope="col" style="font-weight: 700;">Sno</th><th scope="col" style="font-weight: 700;">Product Name</th><th scope="col" style="font-weight: 700;">Qty(O/B)</th><th scope="col" style="font-weight: 700;">Conversion Qty</th><th scope="col" style="font-weight: 700;">Conversion fat</th><th scope="col" style="font-weight: 700;">Production Qty(kgs)</th><th scope="col" style="font-weight: 700;">Loss Qty(kgs)</th><th scope="col" style="font-weight: 700;">ReceivedQty</th></tr></thead></tbody>';
                            for (var i = 0; i < msg.length; i++) {
                                if (msg[i].departmentid == "3") {
                                    var productid = 10;
                                    if (type == "90") {
                                        ...
                                        if (productid == msg[i].productid) {
                                            ...
                                            results += '<td><input id="txt_convertionfat" class="form-control" onkeypress="return isFloat(event);" value="" type="text" onkeyup="fatChange(this);" name="vendorcode"placeholder="Enter cutting"></td>';
        ...
        function save_ghee_production_click() {
            ...
            $(rows).each(function (i, obj) {
                if (($(this).find('#txt_production').val() == "0" && $(this).find('#txt_OB').val() == "0") || $(this).find('#txt_production').val() == undefined) {
                    ...
                    ghee_production_details.push({ productid: $(this).find('#hdn_productid').val(), OB: $(this).find('#txt_OB').val(), convertionqty: $(this).find('#txt_rqty').val(), convertionfat: $(this).find('#txt_convertionfat').val(), productionqty: $(this).find('#txt_production').val(), lossqty: $(this).find('#txt_loss').val(), greciveqty: $(this).find('#txt_greciveqty').val() });
                }
            });
            ...
            var confi = confirm("Do you want to Save Transaction ?");
            if (confi) {
                var data = { 'op': 'save_ghee_production_click', 'qty': qty, 'type': type, 'ghee_production_details': ghee_production_details, 'type': type, 'date': date, 'remarks': remarks, 'btnvalue': btnvalue, 'sno': sno };
                var s = function (msg) {
                    if (msg) {
                        if (msg.length > 0) {
                            alert(msg);
        ...
        function getmeproduction(thisid) {
            ...
            if (productid == "10" || productid == "165" || productid == "166") {
                ...
                results += '<td><input id="txt_convertionfat" onkeypress="return isFloat(event);" class="form-control" value="' + convertionfat + '" type="text" onkeyup="fatChange(this);" name="vendorcode"placeholder="Enter cutting"></td>';
            ...
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        ...
                        results += '<thead><tr><th scope="col" style="font-weight: 700;">Sno</th><th scope="col" style="font-weight: 700;" >Product Name</th><th scope="col" style="font-weight: 700;">O/B</th><th scope="col" style="font-weight: 700;">Sales</th></tr></thead></tbody>';
                        for (var i = 0; i < msg.length; i++) {
                            if (msg[i].departmentid == "3") {
                                results += '<tr>';
                                results += '<th><span id="Span1" style="font-size: 12px; font-weight: 700; color: #0252aa;">' + msg[i].sno + '</span></th>';
                                results += '<th><span id="txt_productname" style="font-size: 12px; font-weight: 700; color: #0252aa;">' + msg[i].productname + '</span></th>';
                                results += '<td><input id="txt_ob" onkeypress="return isFloat(event);" class="form-control" value="' + msg[i].quantity + '" type="text" name="vendorcode"placeholder="Enter dispatch qty"></td>';
                                results += '<td><input id="txt_sales" onkeypress="return isFloat(event);" onkeyup="salesChange(this);" class="form-control" value="" type="text" name="vendorcode" placeholder="Enter dispatch qty"></td>';
                                results += '<td style="display:none" class="8"><input id="hdn_productid" class="form-control" type="text" name="vendorcode" value="' + msg[i].productid + '"></td></tr>';
                            }
                        }
                        results += '</table></div>';
        ...
        function save_ghee_sales_click() {
            ...
            $(rows).each(function (i, obj) {
                if ($(this).find('#txt_dispatchqty').val() != "") {
                    ghee_sales_details.push({ productid: $(this).find('#hdn_productid').val(), Sales: $(this).find('#txt_sales').val() });
                }
            });
            ...
            var confi = confirm("Do you want to Save Transaction ?");
            if (confi) {
                var data = { 'op': 'save_ghee_sales_click', 'ghee_sales_details': ghee_sales_details, 'date': date, 'remarks': remarks, 'btnvalue': btnvalue, 'sno': sno };
                var s = function (msg) {
                    if (msg) {
                        if (msg.length > 0) {
                            alert(msg);
                        ...
                        <table align="center" style="width: 65%;">
                            ...
                            <tr>
                                <td>
                                    <label>
                                        O/B</label>
                                    <input id="txt_ob" type="text" class="form-control" readonly name="vendorcode"  placeholder="Enter o/b" />
                                ...
                                <td style="width: 5px;">
                                 ...
                                 <td>
                                    <label>
                                        O/B Fat</label>
                                    <input id="txt_creamfat" type="text" class="form-control" name="vendorcode" placeholder="Enter fat"  onkeypress="return isFloat(event);"/>
                                </td>
                                <td style="width: 5px;">
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input id="txt_avgfat" type="text" class="form-control" name="vendorcode" placeholder="Enter  Quantity"
                                        readonly />
                                </td>
                            </tr>
                            <tr hidden>
                            ...
                            <tr>
                                <td>
                                    <input id='btn_creamsave' type="button" class="btn btn-success" name="submit" value='Save'
                                        onclick="save_cream_production_click()" />
