<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="coldroomstockreport.aspx.cs" Inherits="coldroomstockreport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdateProgress ID="updateProgress1" runat="server">
     ...
     <section class="content-header">
        <h1>
            Cold Room Stock Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Cold Room Stock Report</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Cold Room Stock Report Details
                </h3>
            </div>
            <div class="box-body">
            ...
            <div >
                <div align="center">
                    <table>
                        <tr>
                        <td>
                          <asp:Label ID="Label6" runat="server" Text="Label">Product Type</asp:Label>&nbsp;
