<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="Tanker_forecastingreport.aspx.cs" Inherits="Tanker_forecastinfreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Tanker ForeCosting Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Tanker ForeCosting Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Tanker ForeCosting Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                    ...
                                    <td style="width:6px;"></td>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Text="Label">Qty</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Tanker Purchase ForeCosting
                                                Report</span><br />
                                        </div>
                                        <table style="width: 80%">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="lblSource" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                        <div>
                                        ...
                                        <br />
                                         <div align="center">
                                         <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Tanker Sales ForeCosting
                                                Report</span><br />
                                                <br />
                                                </div>
                                          <div>
                                        ...
                                        <br />
                                         ...
                                         <div align="center">
                                         <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Tanker Gain/Loss
                                                Report</span><br />
                                                <br />
                                                </div>
                                          <div>
                                            <asp:GridView ID="grddiffreport" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                GridLines="Both" Font-Bold="true">
                                                <EditRowStyle BackColor="#999999" />
                                                <FooterStyle BackColor="Gray" Font-Bold="False" ForeColor="White" />
                                                <HeaderStyle BackColor="#f4f4f4" Font-Bold="False" ForeColor="Black" Font-Italic="False"
