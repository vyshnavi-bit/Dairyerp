<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="sectionwisereport.aspx.cs" Inherits="sectionwisereport" %>
...
<script src="bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function generate_linechart() {
            var section = document.getElementById('slct_section').value;
            var fromdate = document.getElementById('txt_fromdate').value;
            var todate = document.getElementById('txt_todate').value;
            var data = { 'op': 'get_sectionwiseproduction_details', 'section': section, 'fromdate': fromdate, 'todate': todate };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        createChart(msg);
        ...
        function createChart(databind) {
            ...
            //                                }
            var agent = document.getElementById("slct_section");
            var agentname = agent.options[agent.selectedIndex].text;
            var textname = agentname + " Production vs Avg Production --> " + avgqty;
            $("#chart").kendoChart({
                title: {
                    text: textname,
                    color: "#006600",
...
<section class="content-header">
        <h1>
           <i class="fa fa-line-chart" aria-hidden="true"></i> Section Wise Production<small>Details</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Section Wise Production Details</a></li>
        </ol>
    </section>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <select id="slct_section" class="form-control">
                                    <option selected disabled value="Select Batch Type">Select Section</option>
                                    <option>Ghee Section</option>
                                    <option>Curd Section</option>
                                    <option>Butter Section</option>
                                </select>
                            </td>
                            <td style="width: 6px;">
                            </td>
