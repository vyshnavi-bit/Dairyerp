<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="filmoverallwastage.aspx.cs" Inherits="filmoverallwastage" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Over All Film Wastage<small>Report</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Over All Film Wastage Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Over All Film Wastage Report Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                                   ...
                                   <%-- <td>
                                    ...
                                    <td>
                                     ...
                                     <td style="width:169px;">
                                         <asp:Label ID="Label1" runat="server" Text="Label">Batch Type</asp:Label>&nbsp;
                                         <asp:DropDownList ID="ddlslct_Batch" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlbatch_SelectedIndexChanged">
                                         <asp:ListItem Text="Select Batch Type" Value="0">Select Batch Type</asp:ListItem>
                                         </asp:DropDownList>
                                       <%-- <select id="slct_Batch" class="form-control" onchange="slct_Batch_change();">
                                    ...
                                    <td>
                                       <asp:Label ID="Label2" runat="server" Text="Label">Product Name</asp:Label>&nbsp;
                                         <asp:DropDownList ID="ddlslct_product" runat="server" CssClass="form-control">
                                         <asp:ListItem Text="Select Product Name" Value="0">Product Name</asp:ListItem>
                                         </asp:DropDownList>
