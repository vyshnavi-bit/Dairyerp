    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Collection and Payment Report <small>Preview</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Collection and Payment Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                 <td>
                                            <asp:Label ID="Label2" runat="server" Text="Label">Collection Type</asp:Label>&nbsp;
                                            <asp:DropDownList ID="ddlcollectiontype" runat="server" CssClass="form-control">
                                            <asp:ListItem Text="Collection" Value="Collection">Collection</asp:ListItem>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Collection Report</span><br />
                                        </div>
                                        <table style="width: 80%">
                                            <tr>
                                                ...
                                                <td id="tdbalance" runat="server">
                                                    Opp Bal:
                                                    <asp:Label ID="lblopeningbalance" runat="server" ForeColor="Red"></asp:Label>
                                                </td>
                                        ...
                                        <div>
                                         ...
                                         <table>
                                  Clo Bal:      <asp:Label ID="lblclosingbalance" runat="server" ForeColor="Red"></asp:Label>
                                        </table>
                                        <br />
