<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="qualitytestingdetails.aspx.cs" Inherits="qualitytestingdetails" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btn_addsilodetails').click(function () {
        ...
        $('#close_silodetails').click(function () {
        ...
        $('#close_curddetails').click(function () {
        ...
        $('#close_gheedetails').click(function () {
    ...
    function showsilowisedetails() {
        $('#div_batchwise').css('display', 'none');
        $('#div_silowise').css('display', 'block');
        $('#div_curdsection').css('display', 'none');
        $('#div_gheesection').css('display', 'none');
        $('#div_creamsec').css('display', 'none');
        get_Silos();
    ...
    function showcurdsectiondetails() {
        $('#div_batchwise').css('display', 'none');
        $('#div_silowise').css('display', 'none');
        $('#div_curdsection').css('display', 'block');
        $('#div_gheesection').css('display', 'none');
        $('#div_creamsec').css('display', 'none');
        get_curdproduction_details();
        get_product_details();
    ...
    function showgheesectiondetails() {
        $('#div_batchwise').css('display', 'none');
        $('#div_silowise').css('display', 'none');
        $('#div_curdsection').css('display', 'none');
        $('#div_gheesection').css('display', 'block');
        $('#div_creamsec').css('display', 'none');
        get_gheeproductqualitytesting_details();
        get_gheeproduction_details();
    }
    function creamqualitytesting() {
        $('#div_batchwise').css('display', 'none');
        $('#div_silowise').css('display', 'none');
        $('#div_curdsection').css('display', 'none');
        $('#div_gheesection').css('display', 'none');
        $('#div_creamsec').css('display', 'block');
        get_cream_qualitytesting_details();
    }
    ...
    function fillBatchs(msg) {
        var data = document.getElementById('slct_batch_sourcename');
        var length = data.options.length;
        document.getElementById('slct_batch_sourcename').options.length = null;
    ...
    function save_batch_wise_qualitytesting_click() {
        ...
        var SourceID = document.getElementById('slct_batch_sourcename').value;
    ...
    function batch_clearvalues() {
        ...
        document.getElementById('slct_batch_sourcename').selectedIndex = 0;
    ...
    <section class="content">
        <div class="box box-info">
            <div>
                <ul class="nav nav-tabs">
                    <li id="id_tab_documents" class="active"><a data-toggle="tab" href="#" onclick="showbatchwisedetails()">
                        <i class="fa fa-street-view"></i>&nbsp;&nbsp;Batch Wise</a></li>
                    <li id="id_tab_documents1" class=""><a data-toggle="tab" href="#" onclick="showsilowisedetails()">
                        <i class="fa fa-file-text"></i>&nbsp;&nbsp;Silo Wise</a></li>
                    <li id="id_tab_documents2" class=""><a data-toggle="tab" href="#" onclick="showcurdsectiondetails()">
                        <i class="fa fa-file-text"></i>&nbsp;&nbsp;Curd Section</a></li>
                   <li id="id_tab_documents3" class=""><a data-toggle="tab" href="#" onclick="showgheesectiondetails()">
                        <i class="fa fa-file-text"></i>&nbsp;&nbsp;Ghee Section</a></li>
                   <li id="id_tab_documents4" class=""><a data-toggle="tab" href="#" onclick="creamqualitytesting()">
                        <i class="fa fa-file-text"></i>&nbsp;&nbsp;Cream</a></li>
                </ul>
            </div>
            ...
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Batch Wise Quality Testing Entry
                </h3>
            </div>
            <div class="box-body">
                    ...
                    <table>
                        <tr>
                            ...
                            <div class="input-group">
                                ...
                                <span  class="glyphicon glyphicon-plus-sign" onclick="addbatchtesting()"></span> <span onclick="addbatchtesting()">Add Batch Testing</span>
                          </div>
                          </div>
                            </td>
                     </tr>
                ...
                <div style="padding-left:200px;">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="slct_batch_sourcename" class="form-control" > <%--onchange="onchage_batch_sourcename();"--%>
                                </select>
                            </td>
                             <td style="width: 6px;">
                            </td>
            ...
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Silo Wise Quality Testing Entry
                </h3>
            </div>
            <div class="box-body">
                <div id="silo_showlogs" style="text-align: -webkit-right;">
                    <%--<input id="btn_addsilodetails" type="button" name="submit" value='Add Quality' class="btn btn-success" /--%>
                    <table>
                        <tr>
                            <td>
                            <td>
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span  class="glyphicon glyphicon-plus-sign" onclick="addsilowisetesing()"></span> <span onclick="addsilowisetesing()">Add Silo Testing</span>
                          </div>
                          </div>
                            </td>
                     </tr>
                ...
                <div id="div_getsilodata">
                </div>
                <div id='silodetails_fillform' style="display: none;">
                <div style="padding-left:200px;">
                    <table align="center">
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="txt_silodate" class="form-control" type="datetime-local" name="vendorcode"
                                    placeholder="Enter Date" />
                            </td>
                            <td style="width: 6px;">
                            </td>
                            ...
                            <td>
                                <input id="txt_silosample" type="text" class="form-control" name="vendorcode" placeholder="Sample No" />
                            </td>
                        </tr>
                       <%-- <tr>
                            <td>
                    ...
                    <div style="padding-left:200px;">
                        <table align="center">
                            <tr>
                                ...
                                <td colspan="6">
                                    <textarea rows="3" cols="45" id="txt_siloremarks" class="form-control" maxlength="200"
                                        placeholder="Enter Remarks"></textarea>
                                    <%--   <textarea id="txt_siloremarks" class="form-control" rows="5" cols="45" placeholder="Remarks" />--%>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 50px;">
                                ...
                                <td>
                                    <input id="txt_silochemist" type="text" class="form-control" name="vendorcode" placeholder="Chemist" />
                                </td>
                                <td style="width: 6px;">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input id="txt_siloqco" type="text" class="form-control" name="vendorcode" placeholder="QCO" />
                                </td>
                            </tr>
                            <tr hidden>
                                <td>
                                    <label id="lbl_silosno">
                                    </label>
                                </td>
                            </tr>
                       ...
                       <%-- <input id='save_silotestdetails' type="button" class="btn btn-success" name="submit"
                            value='Save' onclick="save_silo_wise_qualitytesting_click()" />
                        <input id='close_silodetails' type="button" class="btn btn-danger" name="Clear" value='Clear'
                            onclick="clearvalues_silo()" />
                        <input id='silo_btnPrint' type="button" class="btn btn-primary" name="Close" value='Print'
                            onclick="javascript:CallPrint('div_axilautofill');" />--%>
                        <br />
                        <div  style="padding-left: 35%;">
                        <table>
                        ...
                        <td>
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span class="glyphicon glyphicon-ok" id="save_silotestdetails1" onclick="save_silo_wise_qualitytesting_click()"></span><span id="save_silotestdetails" onclick="save_silo_wise_qualitytesting_click()">Save</span>
                            </div>
                            </div>
                            </td>
                            <td style="width:10px;"></td>
                            <td>
                                <div class="input-group">
                                <div class="input-group-close">
                                <span class="glyphicon glyphicon-remove" id='close_silodetails1' onclick="clearvalues_silo()"></span><span id='close_silodetails' onclick="clearvalues_silo()">Close</span>
                            </div>
                            </div>
                            </td>
                            </tr>
            ...
            <div id="div_curdsection">
            <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Curd Section Quality Testing Entry
                </h3>
            </div>
            <div class="box-body">
                <div id="curd_showlogs" style="text-align: -webkit-right;">
                    <%--<input id="btn_addcurd" type="button" name="submit" value='Add CurdPacket Details' class="btn btn-success" />--%>
                    <table>
                        <tr>
                            <td>
                            <td>
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span  class="glyphicon glyphicon-plus-sign" onclick="addcurdpacketdetails()"></span> <span onclick="addcurdpacketdetails()">Add CurdPacket Details</span>
                          </div>
                          </div>
                            </td>
                     </tr>
                ...
                <div style="padding-left:200px;">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="txt_curddate" class="form-control" type="datetime-local" name="vendorcode"
                                    placeholder="Enter Date" />
                            </td>
                            <td style="width: 6px;">
                            </td>
                            ...
                            <td>
                                <input id="txt_curdsample" type="text" class="form-control" name="vendorcode" placeholder="Sample No" />
                            </td>
                        </tr>
                            <%--<tr hidden>
                                <td>
                    ...
                    <div style="padding-left:200px;">
                        ...
                        <tr>
                                ...
                                <td>
                                    <input id="txt_curdchemist" type="text" class="form-control" name="vendorcode" placeholder="Chemist" />
                                </td>
                                <td style="width: 6px;">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input id="txt_curdqco" type="text" class="form-control" name="vendorcode" placeholder="QCO" />
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 40px;">
                                ...
                                <td colspan="6">
                                    <textarea rows="3" cols="45" id="txt_curdremarks" class="form-control" maxlength="200"
                                        placeholder="Enter Remarks"></textarea>
                                    <%--   <textarea id="txt_curdremarks" class="form-control" rows="5" cols="45" placeholder="Remarks" />--%>
                                </td>
                            </tr>
                            <tr hidden>
                                <td>
                                    <label id="lbl_curdsno">
                                    </label>
                                </td>
                            </tr>
                        ...
                        <%--<input id='curd_btnvalue' type="button" class="btn btn-success" name="submit"
                            value='Save' onclick="save_curd_packetwise_qualitytesting_click()" />
                        <input id='close_curddetails' type="button" class="btn btn-danger" name="Clear" value='Clear'
                            onclick="clearvalues_curddetails()" />
                        ...
                        <td>
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span class="glyphicon glyphicon-ok" id="curd_btnvalue1" onclick="save_curd_packetwise_qualitytesting_click()"></span><span id="curd_btnvalue" onclick="save_curd_packetwise_qualitytesting_click()">Save</span>
                            </div>
                            </div>
                            </td>
                            <td style="width:10px;"></td>
                            <td>
                                <div class="input-group">
                                <div class="input-group-close">
                                <span class="glyphicon glyphicon-remove" id='close_curddetails1' onclick="clearvalues_curddetails()"></span><span id='close_curddetails' onclick="clearvalues_curddetails()">Close</span>
                            </div>
                            </div>
                            </td>
                            </tr>
            ...
            <div class="box-body">
                <div id="ghee_showlogs" style="text-align: -webkit-right;">
                    <%--<input id="btn_addghee" type="button" name="submit" value='Add Quality Testing' class="btn btn-success" />--%>
                       <table>
                        <tr>
                       <td>
                            <td>
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span  class="glyphicon glyphicon-plus-sign" onclick="addgheedetails()"></span> <span onclick="addgheedetails()">Add Quality Testing</span>
                          </div>
                          </div>
                        </td>
                        </tr>
                ...
                <div style="padding-left:200px;">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="txt_gheedate" class="form-control" type="datetime-local" name="vendorcode"
                                    placeholder="Enter Date" />
                            </td>
                            <td style="width:2px;">
                            ...
                            <td>
                                <input id="txt_gheesample" class="form-control" type="text" name="vendorcode"
                    ...
                    <div style="padding-left:200px;">
                        <table align="center">
                            <tr>
                                ...
                                <td colspan="6">
                                    <textarea rows="3" cols="45" id="txt_gheeremarks" class="form-control" maxlength="200"
                                        placeholder="Enter Remarks"></textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input id="txt_gheechemist" type="text" class="form-control" name="vendorcode" placeholder="Chemist" />
                                </td>
                                <td style="width: 6px;">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input id="txt_gheeqco" type="text" class="form-control" name="vendorcode" placeholder="QCO" />
                                </td>
                            </tr>
                            <tr hidden>
                                <td>
                                    <label id="lbl_gheesno">
                                    </label>
                                </td>
                            </tr>
                       ...
                       <%-- <input id='save_gheetransactions' type="button" class="btn btn-success" name="submit"
                        ...
                        <input id='close_gheedetails' type="button" class="btn btn-danger" name="Clear" value='Clear'
                            onclick="clearvalues_ghee()" />
                        <input id='btnPrint' type="button" class="btn btn-primary" name="Close" value='Print'
                            onclick="javascript:CallPrint('div_axilautofill');" />--%>
                        <div  style="padding-left:35%;">
                        <table>
                        ...
                        <td>
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span class="glyphicon glyphicon-ok" id="save_gheetransactions1" onclick="save_ghee_wise_qualitytesting_click()"></span><span id="save_gheetransactions" onclick="save_ghee_wise_qualitytesting_click()">Save</span>
                            </div>
                            </div>
                            </td>
                            <td style="width:10px;"></td>
                            <td>
                                <div class="input-group">
                                <div class="input-group-close">
                                <span class="glyphicon glyphicon-remove" id='close_gheedetails1' onclick="clearvalues_ghee()"></span><span id='close_gheedetails' onclick="clearvalues_ghee()">Close</span>
                            </div>
                            </div>
                            </td>
                            </tr>
            ...
            <div class="box-body">
                <div id="showlogs_cream" style="text-align: -webkit-right;">
                    ...
                    <table>
                        <tr>
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span  class="glyphicon glyphicon-plus-sign" onclick="addcreadetails()"></span> <span onclick="addcreadetails()">Add Quality Testing</span>
                          </div>
                          </div>
                            </td>
                     </tr>
                ...
                <div style="padding-left:300px;">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="txt_cdate" class="form-control" type="datetime-local" name="vendorcode"
                                    placeholder="Enter Date">
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div style="padding-left:200px;">
                        <table align="center">
                            <tr>
                                ...
                                <td colspan="6">
                                    <textarea rows="3" cols="45" id="txt_cRemarks" class="form-control" maxlength="200"
                                        placeholder="Enter Remarks"></textarea>
                                    <%--   <textarea id="txt_cRemarks" class="form-control" rows="5" cols="45" placeholder="Remarks" />--%>
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 50px;">
                                ...
                                <td>
                                    <input id="txt_cChemist" type="text" class="form-control" name="vendorcode" placeholder="Chemist" />
                                </td>
                                <td style="width: 6px;">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input id="txt_cqco" type="text" class="form-control" name="vendorcode" placeholder="QCO" />
                                </td>
                            </tr>
                            <tr hidden>
                                <td>
                        ...
                        <td>
                            <div class="input-group">
                                <div class="input-group-addon">
                                <span class="glyphicon glyphicon-ok" id="save_creamtest1" onclick="save_cream_qualitytesting_click()"></span><span id="save_creamtest" onclick="save_cream_qualitytesting_click()">Save</span>
                            </div>
                            </div>
                            </td>
                            <td style="width:10px;"></td>
                            <td>
                                <div class="input-group">
                                <div class="input-group-close">
                                <span class="glyphicon glyphicon-remove" id='close_creamtest1' onclick="clearvalues_cream()"></span><span id='close_creamtest' onclick="clearvalues_cream()">Close</span>
                            </div>
                            </div>
                            </td>
                            </tr>
