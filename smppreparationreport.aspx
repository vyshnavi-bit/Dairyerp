<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
 CodeFile="smppreparationreport.aspx.cs" Inherits="smppreparationreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    SMP Details Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">SMP Details Report</a></li>
                </ol>
                </section>
                    ...
                    <div class="box-body">
                        ...
                        <table>
                            ...
                            <asp:CalendarExtender ID="enddate_CalendarExtender2" runat="server" Enabled="True"
                             ...
                             <td>
                             <asp:Button ID="Button1" runat="server" Text="Generate" CssClass="btn btn-success" OnClick="btn_Generate_Click">
                             </asp:Button>
                             </td>
                            </tr>
                            </table>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">SMP Details Report Details</span><br />
