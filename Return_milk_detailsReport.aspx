<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="Return_milk_detailsReport.aspx.cs" Inherits="Return_milk_detailsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <section class="content-header">
        <h1>
            Return Milk Report<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Return Milk Report</a></li>
        </ol>
    </section>
                        ...
                        <div>
                            <div align="center">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" Text="Label">Department Name</asp:Label>&nbsp;
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <div align="center">
                                                ...
                                                <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                    Text=""></asp:Label>
                                                <br />
                                                <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Return Milk Details
                                                    Report</span><br />
                                            </div>
