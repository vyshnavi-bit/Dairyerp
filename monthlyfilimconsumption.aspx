<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="monthlyfilimconsumption.aspx.cs" Inherits="monthlyfilimconsumption" %>
                    ...
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Text="Label">From Month</asp:Label>&nbsp;
                                    ...
                                    <td style="width:3px;">
                                     ...
                                     <td>
                                        <asp:Label ID="Label2" runat="server" Text="Label">To Month</asp:Label>&nbsp;
