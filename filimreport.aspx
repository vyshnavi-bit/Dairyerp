<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="filimreport.aspx.cs" Inherits="filimreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                  <i class="fa fa-usd" aria-hidden="true"></i>  Daily Film Cost Report Per ltr<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Daily Film Cost Report Per ltr</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Daily Film Cost Report Per ltr Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Daily Film Cost Report Per ltr Details</span><br />
                                        ...
                                        <table style="width: 100%; text-align:right; color:Red;font-weight: bold; font-size: 15px;">
                                            <tr>
                                                <td>
                                                    <span>Total Wastage Film(%)</span>
                                                </td>
                                                <td style="width:50px;">
                                                    <asp:Label ID="lbltotalwastage" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>Total Cutting Film(%)</span>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblcuttingfilim" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span>Over All Film Wastage(%)</span>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lbloverallfilim" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <asp:Button ID="btnPrint" runat="Server" CssClass="btn btn-success" OnClientClick="javascript:CallPrint('divPrint');"
                                    Text="Print" />
                                     ...
                                     <asp:Button ID="btnfinalise" runat="Server" CssClass="btn btn-success" OnClick="btn_finalizeclick"
                                    Text="Finalize" />
                            </asp:Panel>
