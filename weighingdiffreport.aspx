<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="weighingdiffreport.aspx.cs" Inherits="weighingdiffreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Weighing Daily Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div>
                                            <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" 
                                                CssClass="gridcls" OnDataBinding="gvMenu_DataBinding" 
