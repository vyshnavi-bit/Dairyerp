...
public partial class otherpartysalevocher : System.Web.UI.Page
{
    SqlCommand cmd;
    string BranchID = "";
    SalesDBManager vdm;
    ...
    protected void btn_Generate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlReportType.SelectedValue == "Buffalo")
            {
                ...
                cmd = new SqlCommand("SELECT directsales_purchase.dcno, directsales_purchase.inwardno AS InwardNo, directsales_purchase.vehicleno, directsales_purchase.doe, directsales_purchase.transtype, directsales_purchase.qty_ltr, directsales_purchase.qty_kgs, directsales_purchase.percentageon, directsales_purchase.snf, directsales_purchase.fat, directsales_purchase.clr, directsales_purchaselogs.milktype, directsales_purchaselogs.rate_on, directsales_purchaselogs.cost, directsales_purchaselogs.calc_on, directsales_purchaselogs.overheadon, directsales_purchaselogs.overheadcost, directsales_purchaselogs.m_std_snf, directsales_purchaselogs.p_std_snf, directsales_purchaselogs.snfplus_on, directsales_purchaselogs.m_snfpluscost, directsales_purchaselogs.p_snfpluscost, directsales_purchaselogs.transport_on, directsales_purchaselogs.transportcost, directsales_purchaselogs.transport, directsales_purchaselogs.m_std_fat, directsales_purchaselogs.m_fatpluscost, directsales_purchaselogs.fatplus_on, directsales_purchaselogs.p_fatpluscost, directsales_purchaselogs.p_std_fat, vendors.vendorname, vendors.tallyoh, vendors.ledgertype FROM directsales_purchase INNER JOIN directsales_purchaselogs ON directsales_purchase.sno = directsales_purchaselogs.purchaserefno INNER JOIN vendors ON directsales_purchase.sectionid = vendors.sno WHERE  (directsales_purchase.entrydate BETWEEN @d1 AND @d2) AND (directsales_purchase.entrytype = @transtype) AND (directsales_purchaselogs.milktype='Buffalo') AND (directsales_purchase.sectionid=@sectionid) ORDER BY doe");
                ...
                if (dtDispatch.Rows.Count > 0)
                {
                    ...
                    foreach (DataRow dr in dtDispatch.Rows)
                    {
                        ...
                        string newreceipt = "0";
                        long countdc = 0;
                        long.TryParse(dr["dcno"].ToString(), out countdc);
                        if (countdc < 10)
                        {
                        ...
                        newrow["INVOICE NO"] = dtapril.ToString("yy") + "-" + dtmarch.ToString("yy") + "E/" + newreceipt;
