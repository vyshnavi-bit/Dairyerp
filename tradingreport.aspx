<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="tradingreport.aspx.cs" Inherits="tradingreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Trading Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Trading Details
                        </h3>
                            ...
                            <table>
                                <tr>
                                   <td style="width:6px;"></td>
                                    <td style="width:6px;"></td>
                                    <td>
                                        <asp:Label ID="lbl_ccoldroom" runat="server" Text="Label">DC From Date</asp:Label>&nbsp;
                                    ...
                                    <td style="width:6px;"></td>
                                    <td>
                                        <asp:Label ID="Label5" runat="server" Text="Label">DC To Date</asp:Label>&nbsp;
                                    ...
                                    <td>
                                        <asp:Panel ID="hideVehicles" runat="server" Visible="false">
                                            <asp:Label ID="Label1" runat="server" Text="Label">Sales Coustmer Name</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div>
                                           <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                GridLines="Both" Font-Bold="true" OnRowDataBound="grdcow_RowDataBound">
                                        ...
                                        <div>
                                            <asp:Panel ID="pnlbuff" runat="server">
                                                <asp:GridView ID="grdbuff" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
