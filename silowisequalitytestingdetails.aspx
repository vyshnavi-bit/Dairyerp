<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="silowisequalitytestingdetails.aspx.cs" Inherits="silowisequalitytestingdetails" %>
...
//            }
        ...
        function filldetails(msg) {
            ...
            results += '<thead><tr><th scope="col">Date</th></th><th scope="col">Silo Name</th><th scope="col">Quantity(kgs)</th><th scope="col">Quantity(ltrs)</th><th scope="col">fat</th><th scope="col">snf</th></tr></thead></tbody>';
            for (var i = 0; i < msg.length; i++) {
                results += '<tr><td style="display:none"><input id="btn_poplate" type="button"  onclick="getme(this)" name="submit" class="btn btn-success" value="Edit" /></td>';
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
           Silo Wise Qualtity Testing <small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operations</a></li>
            <li><a href="#">Silo Wise Qualtity Testing</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Silo Wise Qualtity Testing Entry
                </h3>
            </div>
            <div class="box-body">
                <div id="showlogs" align="center">
                    <input id="btn_addDept" type="button" name="submit" value='Add Qualtity' class="btn btn-success" />
                </div>
                <div id="div_Deptdata">
                </div>
