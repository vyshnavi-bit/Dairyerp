<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="DespatchReport.aspx.cs" Inherits="DespatchReport" %>
                        ...
                        <asp:Panel ID="pnlHide" runat="server" Visible="false">
                            <div id="divPrint">
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td style="width: 62%; padding-left: 10%;">
                                                ...
                                                <asp:Label ID="lblpartyname" runat="server" Text="" Font-Bold="true" Font-Size="16px"
                                        ...
                                        <tr>
                                            <td style="width: 63%; padding-left: 10%;">
                                                ...
                                                <asp:Label ID="lbldto" runat="server" Text="" Font-Bold="true" Font-Size="16px" ForeColor="Red"></asp:Label>
                                            </td>
                                            <td style="width: 20%; padding-left: 0%;">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td style="width: 38%; padding-left: 12%;">
                                            <span style="font-weight: bold;">Unloaded Time:</span>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="width: 38%; padding-left: 12%;">
                                            <span style="font-weight: bold;">Unloading SILO:</span>
                                            <br />
                                            <br />
                                        </td>
                                        <td>
