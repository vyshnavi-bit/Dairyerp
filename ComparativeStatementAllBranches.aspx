<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="ComparativeStatementAllBranches.aspx.cs" Inherits="ComparativeStatementAllBranches" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Comparative Statement All Branches<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Comparative Statement All Branches</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Comparative Statement All Branches
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            ...
                            <asp:Panel ID="hidepanel" ScrollBars="Auto" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Comparative Statement
                                                All Branches</span><br />
                                        </div>
                                        ...
                                        <div style="overflow: scroll;">
                                                <asp:GridView ID="grdReports" runat="server" ForeColor="White" Width="100%" CssClass="gridcls"
                                                    GridLines="Both" Font-Bold="true" OnDataBinding="gvMenu_DataBinding" OnRowDataBound="gvMenu_RowDataBound"
                                                    ShowFooter="true" OnRowCreated="gvMenu_RowCreated">
                                                    <EditRowStyle BackColor="#999999" />
                                                    <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                                    <HeaderStyle BackColor="#465c71" Font-Bold="False" ForeColor="White" Wrap="false"
                                                        Font-Size="Small" />
                                                    <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                                                    <RowStyle BackColor="white" ForeColor="black" Wrap="false" Font-Size="Small" />
