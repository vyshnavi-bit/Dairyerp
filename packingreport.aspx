<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="packingreport.aspx.cs" Inherits="packingreport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Packing Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Packing Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Packing Details
                        </h3>
                            ...
                            <table>
                                <tr>
                                   <td style="width:6px;"></td>
                                    <td style="width:6px;"></td>
                                    <td>
                                        <asp:Label ID="lbl_pack" runat="server" Text="Label">From Date</asp:Label>&nbsp;
                                    ...
                                    <td>
                                     ...
                                     <td style="width:6px;"></td>
                                    <td>
                                        <asp:Button ID="Button2" runat="server" Text="GENERATE" CssClass="btn btn-primary" OnClick="Generate_packing" />
                                    </td>
